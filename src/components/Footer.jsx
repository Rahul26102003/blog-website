        ...
        <div className='px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4'>
            <div className='grid mb-8 lg:grid-cols-6'>
                ...
                <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                        ...
                        <p className='mt-4 text-sm text-gray-500'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Temporibus dolore dolorum eaque optio expedita. Eum incidunt similique ex tempora autem quaerat quas, nam porro laudantium quae earum veritatis, odit in repellat tempore minus? Modi aliquid voluptatum quas suscipit!</p>
                </div>
            </div>
